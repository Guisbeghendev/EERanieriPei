...
const submit = () => {
    ...
    // Substituindo route() por URL estática com o ID do usuário
    form.post(`/admin/users/${props.user.id}`, { // URL para o método update do UserController
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            ...
                            <div v-if="message"
                                 :class="{'bg-green-100 text-green-800': message.includes('sucesso'), 'bg-red-100 text-red-800': message.includes('Erro')}"
                            ...
                            <form @submit.prevent="submit">
                                ...
                                <div class="mb-6 flex flex-col items-center">
                                    ...
                                    <div v-if="props.profile?.avatar_relation?.url || form.avatar"
                                        ...
                                        />
                                        <label for="remove_avatar_checkbox"
                                ...
                                <h3 class="text-lg font-medium text-gray-900 mt-8 mb-4 border-b pb-2">Dados do Perfil
                                    (Opcional)</h3>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            class="mt-1 block w-full"
                                        />
                                        <div v-if="form.errors.state" class="text-red-600 text-sm mt-1">
                                            {{ form.errors.state }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        <label for="other_contact" class="block text-sm font-medium text-gray-700">Outro
                                            Contato</label>
                                        <TextInput
                                            id="other_contact"
                                            type="text"
                                            ...
                                            class="mt-1 block w-full"
                                        />
                                        <div v-if="form.errors.other_contact" class="text-red-600 text-sm mt-1">
                                            {{ form.errors.other_contact }}
                                        </div>
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label for="ranieri_text" class="block text-sm font-medium text-gray-700">Texto
                                        Ranieri</label>
                                    <TextArea
                                        id="ranieri_text"
                                        ...
                                        class="mt-1 block w-full"
                                    ></TextArea>
                                    <div v-if="form.errors.ranieri_text" class="text-red-600 text-sm mt-1">
                                        {{ form.errors.ranieri_text }}
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <TextArea
                                        ...
                                        class="mt-1 block w-full"
                                    ></TextArea>
                                    <div v-if="form.errors.biography" class="text-red-600 text-sm mt-1">
                                        {{ form.errors.biography }}
                                    </div>
                                </div>


                                <h3 class="text-lg font-medium text-gray-900 mt-8 mb-4 border-b pb-2">Associação de
                                    Papéis</h3>
                                <div class="mb-4">
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                        <div v-for="group in groups" :key="group.id" class="flex items-center">
                                            ...
                                            <label :for="`group-${group.id}`"
                                                   class="ml-2 text-sm text-gray-700">{{ group.name }}</label>
                                        </div>
                                    </div>
                                    <div v-if="form.errors.groups" class="text-red-600 text-sm mt-1">
                                        {{ form.errors.groups }}
                                    </div>
                                </div>

                                <div class="flex items-center justify-end mt-4">
                                    <Link href="/admin/users" class="text-gray-600 hover:text-gray-900 mr-4">
                                        Cancelar
                                    </Link>
                                    <PrimaryButton
                                        type="submit"
